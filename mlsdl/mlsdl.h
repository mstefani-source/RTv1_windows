...
SDL_Surface			*mlsdl_new_surface(SDL_Window *sdl_window_pointer,\
														int width, int height);
SDL_Texture			*mlsdl_new_texture(SDL_Renderer *sdl_window_render, \
														int width, int height);
void				*mlsdl_put_texture_to_render(SDL_Renderer \
						*sdl_window_render, SDL_Texture *sdl_window_texture);
